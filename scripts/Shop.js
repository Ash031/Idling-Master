function printShop(){
    ...
    string += "<tr><td><p>+1 Strength</p><button onclick='buy(1)'>20 Moneys</button></td><td>"
    ...
    string += "<tr><td><p>+10 Strength</p><button onclick='buy(4)'>200 Moneys</button></td><td>"
    ...
    string += "<tr><td><p>+100 Strength</p><button onclick='buy(7)'>2000 Moneys</button></td><td>"
    ...
    string += "<tr><td><p>+1000 Strength</p><button onclick='buy(13)'>20000 Moneys</button></td><td>"
